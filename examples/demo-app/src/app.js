...
const KeplerGl = require('@indranil-kepler.gl/components').injectComponents([
...
import {processCsvData, processGeojson, processRowObject} from '@indranil-kepler.gl/processors';
...
class App extends Component {
  ...
  _loadMockNotifications = () => {
    const notifications = [
      [{message: 'Welcome to indranil-kepler.gl'}, 3000],
  ...
  render() {
    return (
      <ThemeProvider theme={theme}>
        <GlobalStyle
          // this is to apply the same modal style as indranil-kepler.gl core
