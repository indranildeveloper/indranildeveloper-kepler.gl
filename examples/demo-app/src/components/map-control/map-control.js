...
import {Icons, IconRoundSmall, MapControlButton} from '@indranil-kepler.gl/components';
...
// convert https://raw.githubusercontent.com/keplergl/indranil-kepler.gl-data/master/nyctrips/config.json
// to https://github.com/keplergl/indranil-kepler.gl-data/blob/master/movement_pittsburgh/config.json
function getURL(url) {
  return url
    ? url
