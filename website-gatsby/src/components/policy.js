            ...
            <Content>
              ...
              <StyledCaption>
                ...
                <div className="description">
                  <h3>
                    <a href="https://indranildeveloper-kepler.gl">indranildeveloper-kepler.gl</a> is an open source project. Its source code is available at <a
                    href={GITHUB_PROJECT}>indranildeveloper-kepler.gl Github project</a>.
                  </h3>
                  <span className="description-content">
                    ...
                    issues can be submitted at <a href={GITHUB_PROJECT_ISSUES}>indranildeveloper-kepler.gl Github issues</a>.
                    Questions can be asked on the project's mailing lists, which you can subscribe at <a href={MAILING_LIST_URL}>indranildeveloper-kepler.gl Mailing list</a>.
                    ...
                    Please note that the indranildeveloper-kepler.gl project and Urban Computing Foundation do not otherwise provide support for users of indranildeveloper-kepler.gl software.
                  </span>
                </div>
              </StyledCaption>
            </Content>
