              ...
              <StyledCaption>
                ...
                <div className="description">
                  ...
                  <span className="description-content">
                    ...
                    <a href={MAILING_LIST_URL}>indranil-kepler.gl Mailing list</a>. Please review
                    the applicable <a href={CONTRIBUTING_URL}>contributing guidelines</a> and
                    procedures in connection with your submissions. Please note that the
                    indranil-kepler.gl project and Urban Computing Foundation do not otherwise
                    provide support for users of indranil-kepler.gl software.
                  </span>
                </div>
              </StyledCaption>
            </Content>
