...
LONG_DESCRIPTION = 'A jupyter widget for indranil-kepler.gl, an advanced geospatial visualization tool, to render large-scale interactive maps.'

setup_args = {
    'name': 'keplergl',
    'version': version,
    'description': 'This is a simple jupyter widget for indranil-kepler.gl, an advanced geospatial visualization tool, to render large-scale interactive maps.',
    ...
    'url': 'https://github.com/keplergl/indranil-kepler.gl/tree/master/bindings/indranil-kepler.gl-jupyter',
    'keywords': [
        'ipython',
        'jupyter',
        'widgets',
