...
![select filters](https://d1a3f4spazzrp4.cloudfront.net/indranildeveloper-kepler.gl/documentation/image1.png "select filters")
...
![choose a dataset](https://d1a3f4spazzrp4.cloudfront.net/indranildeveloper-kepler.gl/documentation/image29.png "choose a dataset")
