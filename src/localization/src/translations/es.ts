...
export default {
  ...
  modal: {
    ...
    addStyle: {
      ...
      publishSubtitle7:
        'aquí. *indranildeveloper-kepler.gl es una aplicación cliente, los datos quedan en tu navegador..',
    ...
    shareMap: {
      ...
      shareDisclaimer:
        'indranildeveloper-kepler.gl guardará los datos del mapa en el almacenage de tu nube personal, sólo quien tenga el enlace podra acceder al mapa y a los datos . ' +
        'Puedes editar/borrar el archivo de datos en tu cuenta en la nube en cualquier momento.',
      gotoPage: 'Ves a la página de {currentProvider} de indranildeveloper-kepler.gl'
    },
    statusPanel: {
    ...
    exportMap: {
      ...
      json: {
        ...
        configDisclaimer:
          'La configuración del mapa será incluida en el archivo Json. Si utilitzas indranildeveloper-kepler.gl en tu propia app puedes copiar esta configuración y pasarla a  ',
        selection:
          'Exportar los datos del mapa y la configuración en un solo archivo Json. Posteriormente puedes abrir este mismo mapa cargando este mismo archivo a indranildeveloper-kepler.gl.',
        disclaimer:
    ...
    iconInfo: {
      ...
      code: 'ícono',
      description2: ' indranildeveloper-kepler.gl automáticamente creará una capa de ícono.',
      example: 'Ejemplo:',
      icons: 'Iconos'
    },
    storageMapViewer: {
    ...
    loadStorageMap: {
      back: 'Atrás',
      goToPage: 'Ves a la página {displayName} de indranildeveloper-kepler.gl',
  ...
  fileUploader: {
    ...
    disclaimer:
      '*indranildeveloper-kepler.gl es una aplicación al lado cliente que no utiliza ningún servidor. Los datos sólo existen en tu máquina/navegador. ' +
