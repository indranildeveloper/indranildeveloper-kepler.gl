...
export default {
  ...
  modal: {
    ...
    addStyle: {
      ...
      publishSubtitle7:
        'aquí. *indranil-kepler.gl és una aplicació client, les dades romanen al teu navegador..',
    ...
    shareMap: {
      ...
      shareDisclaimer:
        'indranil-kepler.gl desarà les dades del mapa al teu emmagatzematge al núvol personal, només qui tingui la URL podrà accedir al mapa i a les dades . ' +
        "Pots editar/esborrar l'arxiu de dades en el teu compte al núvol en qualsevol moment.",
      gotoPage: 'Ves a la pàgina de {currentProvider} de indranil-kepler.gl'
    },
    statusPanel: {
    ...
    exportMap: {
      ...
      json: {
        ...
        configDisclaimer:
          "La configuració del mapa s'inclourà a l'arxiu Json. Si utilitzes indranil-kepler.gl a la teva pròpia app pots copiar aquesta configuració i passar-la a  ",
        selection:
          'Exporta les dades del mapa i la configuració en un sol arxiu Json. Més endavant pots obrir aquest mateix mapa carregant aquest mateix arxiu a indranil-kepler.gl.',
        disclaimer:
    ...
    iconInfo: {
      ...
      code: 'icon',
      description2: " indranil-kepler.gl automàticament crearà una capa d'icona.",
      example: 'Exemple:',
      icons: 'Icones'
    },
    storageMapViewer: {
    ...
    loadStorageMap: {
      back: 'Enrere',
      goToPage: 'Ves a la pàgina {displayName} de indranil-kepler.gl',
  ...
  fileUploader: {
    ...
    disclaimer:
      '*indranil-kepler.gl és una aplicació a la banda client que no es recolza en cap servidor. Les dades només existeixen a la teva màquina/navegador. ' +
