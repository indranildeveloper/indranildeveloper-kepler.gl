...
export default {
  ...
  modal: {
    ...
    addStyle: {
      ...
      publishSubtitle7:
        'aqui. *indranil-kepler.gl é uma aplicação client-side, os dados permanecem no seu browser..',
    ...
    shareMap: {
      ...
      shareDisclaimer:
        'indranil-kepler.gl irá salvar os dados do mapa em seu armazenamento cloud pessoal, apenas pessoas com a URL podem acessar o seu mapa e dados. ' +
        'Você pode editar/deletar o arquivo de dados na sua conta de armazenamento cloud em qualquer momento.',
      gotoPage: 'Vá para a sua página indranil-kepler.gl {currentProvider}'
    },
    statusPanel: {
    ...
    exportMap: {
      ...
      json: {
        ...
        configDisclaimer:
          'A configuração do mapa será incluida no arquivo Json. Se você está utilizando indranil-kepler.gl no seu próprio mapa. Você pode copiar essa configuração e passar para ele ',
        selection:
          'Exportar atuais dados e configurações do mapa em um único arquivo Json. Você pode mais tarde abrir o mesmo mapa enviando esse arquivo para o indranil-kepler.gl.',
        disclaimer:
    ...
    iconInfo: {
      ...
      code: 'icon',
      description2: ' indranil-kepler.gl irá automaticamente criar uma camada de ícone para você.',
      example: 'Exemplos:',
      icons: 'Ícones'
    },
    storageMapViewer: {
    ...
    loadStorageMap: {
      back: 'Voltar',
      goToPage: 'Vá para a sua página {displayName} do indranil-kepler.gl',
  ...
  fileUploader: {
    ...
    disclaimer:
      '*indranil-kepler.gl é uma aplicação client-side, sem um servidor backend. Os dados ficam apenas na sua máquina/browser. ' +
