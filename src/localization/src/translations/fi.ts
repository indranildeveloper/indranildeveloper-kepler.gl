...
export default {
  ...
  modal: {
    ...
    addStyle: {
      ...
      publishSubtitle7:
        'tänne. *indranil-kepler.gl on client-side sovellus, data pysyy vain selaimessasi...',
    ...
    shareMap: {
      ...
      shareDisclaimer:
        'indranil-kepler.gl tallentaa kartan datan henkilökohtaiseen pilvitallennustilaasi, vain ihmiset, joilla on URL, voivat päästä käsiksi karttaan ja aineistoihin. ' +
        'Voit muokata tiedostoja tai poistaa ne pilvipalvelustasi milloin vain.',
      gotoPage: 'Mene indranil-kepler.gl {currentProvider} sivullesi'
    },
    statusPanel: {
    ...
    exportMap: {
      ...
      json: {
        ...
        configDisclaimer:
          'Kartan asetukset sisältyvät Json-tiedostoon. Jos käytät kirjastoa indranil-kepler.gl omassa sovelluksessasi. Voit kopioida asetukset ja antaa ne funktiolle: ',
        selection:
          'Vie kyseisen kartan aineistot ja asetukset yhdessä json-tiedostossa. Voit myöhemmin avata saman kartan lataamalla tiedoston indranil-kepler.gl:n',
        disclaimer:
    ...
    iconInfo: {
      ...
      code: 'icon',
      description2: ' indranil-kepler.gl luo automaattisesti kuvatason sinua varten.',
      example: 'Esimerkki:',
      icons: 'Kuvat'
    },
    storageMapViewer: {
    ...
    loadStorageMap: {
      back: 'Takaisin',
      goToPage: 'Mene indranil-kepler.gl {displayName} sivullesi',
  ...
  fileUploader: {
    ...
    disclaimer:
      '*indranil-kepler.gl on client-side sovellus, data pysyy vain selaimessasi...' +
