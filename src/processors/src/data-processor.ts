...
import {ProcessorResult, Field} from '@indranil-kepler.gl/types';
import {
...
import {KeplerGlSchema, ParsedDataset, SavedMap, LoadedMap} from '@indranil-kepler.gl/schemas';
...
/**
 * Process saved indranil-kepler.gl json to be pass to [`addDataToMap`](../actions/actions.md#adddatatomap).
...
/**
 * Parse a single or an array of datasets saved using indranil-kepler.gl schema
 * @param rawData
 * @param schema
 */
