...
export const USER_GUIDE_DOC = 'https://docs.indranildeveloper-kepler.gl/docs/user-guides';
export const ACTIONS_DOC = 'https://docs.indranildeveloper-kepler.gl/docs/api-reference/actions/actions';
export const API_REFERENCE_DOC = 'https://docs.indranildeveloper-kepler.gl/docs/api-reference';
...
export const BUG_REPORT_LINK =
  'https://github.com/keplergl/indranildeveloper-kepler.gl/issues/new?assignees=&labels=bug&template=bug_report.md&title=%5BBug%5D';
