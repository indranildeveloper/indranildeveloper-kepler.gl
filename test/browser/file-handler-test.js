...
import {generateHashIdFromString} from '@indranil-kepler.gl/utils';
import {processFileData, readFileInBatches, csvWithNull} from '@indranil-kepler.gl/processors';
...
test('#file-handler -> readFileInBatches.keplerMap -> processFileData', async t => {
  ...
  t.deepEqual(
    batch4.value.data,
    keplerglMap,
    'batch4 should return saved indranil-kepler.gl map json'
  );
