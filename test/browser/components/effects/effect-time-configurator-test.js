...
import {LIGHT_AND_SHADOW_EFFECT_TIME_MODES} from '@indranil-kepler.gl/constants';
import {appInjector, EffectTimeConfiguratorFactory} from '@indranil-kepler.gl/components';
