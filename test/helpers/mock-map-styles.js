...
import {BASE_MAP_COLOR_MODES, DEFAULT_LAYER_GROUPS} from '@indranil-kepler.gl/constants';

/** @type {import('@indranil-kepler.gl/reducers').BaseMapStyle} */
export const MOCK_MAP_STYLE = {
  id: 'dark-matter',
  label: 'DarkMatter',
  url: 'mapbox://styles/xxxxx/abcdefg',
  icon: 'https://my.icon.net/indranil-kepler.gl/test/taro.png',
...
export const MOCK_MAP_STYLE_LIGHT = {
  ...
  icon: 'https://my.icon.net/indranil-kepler.gl/test/blue.png',
  layerGroups: DEFAULT_LAYER_GROUPS,
...
/** @type {import('@indranil-kepler.gl/reducers').MapStyles} */
